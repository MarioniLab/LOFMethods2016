...
all.out[["Protocol Name"]] <- c("Obtaining HeLa cells",
                                "Culturing HeLa cells",
                                "Depleting the lncRNA",
                                "Extracting RNA",
                                "Creating libraries",
